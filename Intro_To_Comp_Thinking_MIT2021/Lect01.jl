...
- Numbers that change over time (**time series**): 
  ...
  - Signaling network quantifications
  - Weight
...
philip[650:800, 250:philip_width]
...
# ╔═╡ 713e2f04-8a22-4ee0-aa1c-913c3375af57
Dump(color_black)

# ╔═╡ 60256700-78bc-4126-b547-498f465d1ae0
color_black.r
...
philip_inverted = philip[end:-1:1,end:-1:1]
...
if !@isdefined(create_bar)
	...
	let
		...
		elseif result[[1,50,100]] != [0,1,0] #TSK TSK, should check more than the middle element
			keep_working()
		else
			correct()
		end
...
# ╔═╡ 3e2ddcbc-1ea0-4d20-850c-d16c26d61f83
myface1
