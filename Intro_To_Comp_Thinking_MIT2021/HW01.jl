...
# ╔═╡ ac45210d-6b92-45a2-8158-7cfff66c4846
thebar = zeros(100)

# ╔═╡ bb458082-3db0-49be-b5bb-dbe51aa0d6a2
thebar[40:59] .= 1
...
# ╔═╡ 86f56c45-6adc-44bb-b562-9c3a10ae4ce4
function get_greens(image::AbstractMatrix)
	# your code here!
	return get_green.(image)
end

# ╔═╡ 76afa2eb-429b-46ab-aba3-e4f630944055
function get_blue(pixel::AbstractRGB)
	# your code here!
	return RGB(pixel).b
end

# ╔═╡ 4f56ec17-49d0-40ad-9835-c57fb772f369
...
function custom_filter(pixel::AbstractRGB)
	...
	return quantize(noisify(pixel,.01))
end
